  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content1">
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/sys/checksave" method="post">
          <input type="hidden" name="id" value="${appInfo.id}">
          <input type="hidden" name="versionId" value="${appInfo.versionId}">
